...
import { createConnection, getConnectionOptions } from './connection';
import { EntityProperty, FactoryFunction } from './types';
...
export class EntityFactory<Entity, Context> {
  ...
  public async seed(
    ...
    printWarning(
      'The seed() method is deprecated please use the create() method instead',
    );
  ...
  public async seedMany(
    ...
    printWarning(
      'The seedMany() method is deprecated please use the createMany() method instead',
    );
